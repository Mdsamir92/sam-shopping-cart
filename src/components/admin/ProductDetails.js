    ...
    return (
        <div>
            <div className="py-5 flex justify-between items-center">
                ...
                {/* Add Product Button  */}
                <Link to={'/addproduct'}>
                    <button className="cart-btn px-5 py-2 bg-pink-50 border border-pink-100 rounded-lg">Add Product</button>
                </Link>
            </div>
            {/* Loading  */}
                        ...
                        {getAllProduct.map((item, index) => {
                            ...
                            return (
                                <tr key={index} className="text-pink-300">
                                    ...
                                    <td className="h-14 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 first-letter:uppercase ">
                                        <div className="flex justify-center">
                                            <img className="w-24 " src={productImageUrl} alt="" />
                                        </div>
                                    </td>
                                    ...
                                    className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 cursor-pointer ">
                                   Edit </td>
                                    <td onClick={()=> deleteProduct(id)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 cursor-pointer ">
                                   Delete </td>
                                </tr>
                            )
                        })}
