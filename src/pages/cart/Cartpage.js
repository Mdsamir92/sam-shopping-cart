                                            ...
                                            <div key={index} className="">
                                                ...
                                                <div className="mb-2 flex">
                                                    <div className="min-w-24 flex">
                                                        ...
                                                        <button onClick={quantity <= 1 ? () => deleteCart(id) : () => remove(item)}
                                                        ...
                                                        <input
                                                            ...
                                                            value={quantity}
                                                        />
                                                        <button onClick={() => send(item)} type="button" className="flex h-7 w-7 items-center justify-center">
                                                            +  </button>
                                                    ...
                                                    <div className="ml-6 flex text-sm">
                                                        <button onClick={() => deleteCart(item.id)} type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                                                            <i size={12} className="fa-solid fa-trash-can text-red-500"></i>
